...
export default function CompanyForm() {
    ...
    return (
        <div className="flex items-center justify-center px-4 py-10 bg-gray-50 dark:bg-gray-900">
            <div className="w-full max-w-4xl p-8 md:p-10">
                ...
                </h1>
                {
                    companyProfile?.map((company: any) => {
                        return (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6" key={company.id}>
                                <div className="hidden">
                                    <Input type="hidden" id="user_id" value={user?.id as number} {...register("user_id")} />
                                </div>
                                <div>
                                    <Label className="text-sm mb-1">Company Name</Label>
                                    <Input type="text" id="company_name" defaultValue={company.company_name} placeholder="e.g. OpenAI" {...register("company_name")} />
                                </div>

                                <div>
                                    <Label className="text-sm mb-1">Company Address</Label>
                                    <Input type="text" id="company_address" 
                                    placeholder="123 Street, City" {...register("company_address")}
                                ...
                                <div>
                                    ...
                                    <Input type="text" id="company_phone_number"
                                     placeholder="e.g. +1234567890" {...register("company_phone_number")}
                                ...
                                <div>
                                    ...
                                    placeholder="e.g. hr@openai.com" {...register("company_email")}
                                    defaultValue={company.company_email}
                                    />
                                </div>

                                <div>
                                    <Label className="text-sm mb-1">Website URL</Label>
                                    <Input type="url" id="company_website_url" 
                                    placeholder="https://example.com" {...register("company_website_url")}
                                    defaultValue={company.company_website_url}
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    placeholder="https://linkedin.com/company/xyz" {...register("linkedin_url")}
                                ...
                                <div>
                                    ...
                                    <Controller
                                        ...
                                        name="industry"
                                        render={({ field }) => (
                                            <Select onValueChange={field.onChange} value={field.value} defaultValue={company.industry}>
                                ...
                                <div>
                                    <Label className="text-sm mb-1">Company Size</Label>
                                    <Input type="text" id="company_size"
                                     placeholder="e.g. 100-500 employees" {...register("company_size")}
                                     defaultValue={company.company_size}
                                     />
                                </div>

                                <div>
                                    <Label className="text-sm mb-1">Founded Year</Label>
                                    <Input type="text" id="founded_year" 
                                    placeholder="e.g. 2015" {...register("founded_year")}
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    {imagePreview && (
                                        <div className="imagePreview my-4 flex gap-x-2.5">
                                            <img src={imagePreview ? imagePreview : company.logo} alt="avatar" className="w-full h-full object-cover" />
