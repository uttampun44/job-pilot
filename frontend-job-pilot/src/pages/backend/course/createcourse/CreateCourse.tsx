...
import { Upload, DollarSign, BookOpen, Target, FileText, Image } from 'lucide-react'
        ...
        <Card className="shadow-lg">
          <CardHeader className="space-y-1 pb-6">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-2xl md:text-3xl font-bold">Create New Course</CardTitle>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Upload a high-quality image (JPG, PNG, or WebP). Recommended size: 1200x630px
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Provide a detailed description of your course content, structure, and what students will learn.
                  </p>
