...
<path d="M22.5 17.5C22.7761 17.5 23 17.7239 23 18C23 18.2761 22.7761 18.5 22.5 18.5C22.2239 18.5 22 18.2761 22 18C22 17.7239 22.2239 17.5 22.5 17.5Z" fill="#18191C" stroke="#0A65CC" stroke-width="2"/>
</svg>
  ),
  level: (
